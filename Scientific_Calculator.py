...
txtDisplay = Entry(calc,font=('arial',20,'bold'),bg="Plum",bd=30,width=29,justify=RIGHT)
...
btnClear = Button(calc,text=chr(67),width=6,height=2,font=('arial',20,'bold'),bd=4,
                  bg="BlueViolet",command=added_value.Clear_Entry).grid(row=1,column=0,pady=1)
btnAllClear = Button(calc,text=chr(67) + chr(69),width=6,height=2,font=('arial',20,'bold'),bd=4,
                  bg="BlueViolet",command=added_value.all_Clear_Entry).grid(row=1,column=1,pady=1)
#=========================================================================

btnSq = Button(calc,text="√",width=6,height=2,font=('arial',20,'bold'),bd=4,
                  bg ="BlueViolet",command=added_value.squared).grid(row=1,column=2,pady=1)
...
btnZero = Button(calc,text="0",width=6,height=2,font=('arial',20,'bold'),bd=4,
                  bg="BlueViolet",command = lambda: added_value.numberEnter(0)).grid(row=5,column=0,pady=1)
